    ...
    <section className="py-24 bg-navy-dark text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="font-sans text-sm text-beige-light/70 mt-5 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {ADVANTAGES.map((item, idx) => (
            <div
              key={idx}
              className="group p-8 bg-white/[0.03] hover:bg-white/[0.07] border border-white/10 hover:border-gold/30 rounded-none transition-all duration-500 flex flex-col items-center text-center relative"
            >
              ...
              {/* Icon Container */}
              <div className="mb-6 p-4 bg-white/[0.04] group-hover:bg-gold/10 rounded-none transition-colors duration-500 border border-white/5 group-hover:border-gold/20 flex items-center justify-center">
                {getIcon(item.icon)}
              </div>
              ...
              <p className="font-sans text-xs text-beige-light/70 leading-relaxed font-light">
                {item.description}
              </p>
            </div>
          ))}
