    ...
    <footer className="bg-navy-dark text-white py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center text-center space-y-8">
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="text-[10px] font-sans tracking-[0.3em] text-beige-light/60 uppercase font-medium mt-1">
        ...
        <div className="flex justify-center space-x-6">
          ...
          <a
            ...
            className="p-3 bg-white/[0.03] hover:bg-gold/10 border border-white/10 hover:border-gold/30 text-white hover:text-gold transition-all duration-300 flex items-center justify-center space-x-2.5 px-6 font-sans text-xs tracking-wider uppercase font-semibold cursor-pointer"
          >
        ...
        <div className="space-y-2">
          <p className="font-sans text-xs text-beige-light/60 tracking-wide">
            Copyright © AMZ | Website Developed By ArrizalGFX.
          </p>
          <p className="font-sans text-[10px] text-beige-light/40">
